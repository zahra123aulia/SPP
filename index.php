...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <?php
        if (!empty($_SESSION['petugas']['level']) && ($_SESSION['petugas']['level'] == 'admin')) {
        ?>
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <!-- Nav Item - Dashboard -->
                <li class="nav-item active <?php echo (empty($_GET['page']) ? 'active' : '') ?>">
            ...
            if (!empty($_SESSION['petugas']['level']) && ($_SESSION['petugas']['level'] == 'petugas')) {
            ?>
                <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">
                                    <?php
                                    if (!empty($_SESSION['petugas']['id_petugas'])) {
                                ...
                                <img class="img-profile rounded-circle" src="https://teknogram.id/gallery/foto-profil-wa/keren/pp-wa-kosong-keren-5.jpg">
                            </a>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="id_spp" class="form-control">
                                                ...
                                                ?>
                                                    <option value="<?php echo $spp['id_spp'] ?>"><?php echo $spp['tahun'] ?> - Rp. <?php echo $spp['nominal'] ?></option>
                                                <?php
                                                }
                                                ?>
                                            </select>
